  ...
  const generateImage = async () => {
    ...
    try {
      ...
      if (angle === 'default') {
        ...
        prompt = "ARCHITECTURAL INTERIOR RE-DESIGN: 1. PRESERVE the exact window boundaries from image 1. 2. INSTALL the EXACT window system from image 2. 3. CLONE PRECISELY: The frame thickness, the specific metallic color, and the internal decorative grille pattern must be an exact match to image 2. 4. Match the glass transparency and hardware details (handles/locks) from image 2. 5. Surround with a luxury modern interior that complements the specific window style. 6. Photorealistic, 8k resolution, professional lighting.";
      } else if (angle === 'high') {
