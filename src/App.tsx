  ...
  const generateImage = async () => {
    ...
    try {
      ...
      if (angle === 'default') {
        ...
        prompt = "MODERN LIGHT LUXURY INTERIOR: 1. Preserve the window structural frame from image 1. 2. Apply the EXACT system window design, metallic finish, and internal decorative patterns from image 2. 3. Replicate the specific glass transparency. 4. Transform the room into a modern light luxury style with elegant high-end furniture (sofa, coffee table), marble flooring, and sophisticated ambient lighting. 5. Maintain professional architectural photography quality with 8k resolution.";
      } else if (angle === 'high') {
