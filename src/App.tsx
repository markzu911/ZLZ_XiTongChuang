  ...
  const generateImage = async () => {
    ...
    try {
      ...
      if (angle === 'default') {
        ...
        prompt = "MODERN LIGHT LUXURY INTERIOR: 1. STRICTLY PRESERVE the exact number, boundaries, proportions, and structural framework of the original windows from image 1. DO NOT merge multiple windows into a single large window or change their shapes (e.g. do not change rectangular windows to arched). 2. Apply the EXACT system window design, EXACT frame color, edge thickness, metallic finish, and internal decorative patterns from the product image (image 2). 3. Replicate the specific glass transparency from image 2. 4. Transform the room into a modern light luxury style with elegant high-end furniture (sofa, coffee table), marble flooring, and sophisticated ambient lighting. 5. Maintain professional architectural photography quality with 8k resolution.";
      } else if (angle === 'high') {
